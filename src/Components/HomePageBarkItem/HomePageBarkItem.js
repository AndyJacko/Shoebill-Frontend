...
const HomePageBarkItem = ({ addLikes, loggedInUser, post }) => {
      ...
      <div className="home-page-bark-item-bark-container">
        <div>
          <Link to={`/users/${post.user._id}`}>
            <strong>
              {post.user.realname ? post.user.realname : post.user.username}
              &nbsp;
            </strong>
          </Link>
          <Link to={`/users/${post.user._id}`}>
        ...
        <div className="home-page-bark-item-crl-container">
          ...
          <div
            className="home-page-bark-item-crl add-like"
          ...
          {loggedInUser && loggedInUser._id === post.user._id && (
            <div className="home-page-bark-item-crl">
